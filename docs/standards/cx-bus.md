...
Cette page est une **passerelle volontairement minimale** : la spécification complète, versionnée et détaillée du standard CX-Bus vit dans le dépôt, en dehors de l'arborescence `docs/`, afin de rester proche des sources techniques (schémas, définitions EEPROM, exemples de modules) qu'elle décrit.
