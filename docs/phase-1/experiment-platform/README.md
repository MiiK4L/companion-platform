...
| Convention de valeurs `[DS]/[C]/[H]/[P]/[BL]/[M]` | lots documentaires (ex. [lot-2](../lot-2/README.md)) | Le socle **produit** des données `[M]` **uniquement en mode réel** (voir ci-dessous). |
