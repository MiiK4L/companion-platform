...
| --- | --- | --- | --- | --- | --- |
| R1 | Mainteneur | fin L1 / L2 | Décompte formel ; **arbitrage** (module alt., custom, expander/partage bus, réduction périmètre, optim. logicielle) | à évaluer | consolidé en L9 ; accepté/clos lors des campagnes de mesure (Phase 1) |
| R2 | Mainteneur | fin L2 | Cartographier accès SPI ; CS dédiés / arbitrage ; SPI module optionnel | à évaluer | consolidé en L9 ; accepté/clos lors des campagnes de mesure (Phase 1) |
...
| R5 | Mainteneur | fin L2 | Isolation/commutation bus ; protections ; banc hot-plug (seuils reproductibles) | à évaluer | consolidé en L9 ; accepté/clos lors des campagnes de mesure (Phase 1) |
| R6 | Mainteneur | fin L3 | Rail d'identification isolé/limité ; comparer ≥ 2 architectures | à évaluer | consolidé en L9 ; accepté/clos lors des campagnes de mesure (Phase 1) |
| R7 | Mainteneur | fin L8 | Chiffrer RAM/flash ; repli sur modèle statique / bundle OTA | à évaluer | à décider en L8/L9 |
| R8 | Mainteneur | continue | ≥ 2 sources par composant critique ; veille cycle de vie | à évaluer | consolidé en L9 ; accepté/clos lors des campagnes de mesure (Phase 1) |
| R9 | Mainteneur | fin L1 / L5 | Enveloppe mécanique tôt ; contraintes de forme au dimensionnement | à évaluer | consolidé en L9 ; accepté/clos lors des campagnes de mesure (Phase 1) |

## Disposition au checkpoint documentaire (Lot 9)

Le [Lot 9](lot-9/README.md) **consolide** l'analyse des risques mais **n'en
accepte ni n'en clôt aucun** : le checkpoint documentaire ne fournit **aucune
...
- **R1–R9 restent Ouverts / En analyse.** Aucune mitigation n'est **vérifiée**
  ...
  base documentaire.
- La **disposition** (acceptation, clôture ou mitigation vérifiée) intervient lors
  des **campagnes de mesure de la Phase 1**, à l'exécution des protocoles associés
  — voir la [feuille de route des décisions](lot-9/decision-roadmap.md) et la
  [préparation des campagnes de mesure](lot-9/campaign-readiness.md).
